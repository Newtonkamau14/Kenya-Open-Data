...
router
  ...
  .get(ApiController.getCountiesPopulation);
router
...
router.route("/counties/registeredvoters").get(ApiController.getCountiesRegisteredVoters);
...
router
  ...
  .get(ApiController.getCountyByCountyCode);
